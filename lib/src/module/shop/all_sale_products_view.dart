...
// class AllSaleProductsView extends StatelessWidget {
//   AllSaleProductsView({
//     Key? key,
...
//         ..add(const GetAllSortedProductsByQueryEvent('isSale', true)),
...
//             return SaleView(
//               allProductsSale: state.allSortedProducts,
...
class AllSaleProductsView extends StatelessWidget {
  AllSaleProductsView({
    Key? key,
    //required this.allProductsSale,
  }) : super(key: key);

  //final List<ProductEntity> allProductsSale;

  @override
  Widget build(BuildContext context) {
    final allProductsSale = ProductData().allSaleProducts;
    return Scaffold(
      body: Column(
        children: [
          Stack(
          ...
          Expanded(
            child: gridView(allProductsSale),
          ),
        ],
      ),
    );
