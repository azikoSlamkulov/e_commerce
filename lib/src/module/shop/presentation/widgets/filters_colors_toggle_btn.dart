...
class FiltersColorsoggleButton extends StatefulWidget {
  const FiltersColorsoggleButton({
    Key? key,
  ...
  @override
  State<FiltersColorsoggleButton> createState() =>
      _FiltersColorsoggleButtonState();
}

class _FiltersColorsoggleButtonState extends State<FiltersColorsoggleButton> {
  @override
