...
class TabletProfileViwe extends StatefulWidget {
  const TabletProfileViwe({Key? key}) : super(key: key);

  @override
  State<TabletProfileViwe> createState() => _TabletProfileViweState();
}

class _TabletProfileViweState extends State<TabletProfileViwe> {
